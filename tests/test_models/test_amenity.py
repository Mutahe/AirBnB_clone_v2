...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """Test save method and check if it updates"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_creates_dict(self):
        """Test if to_dict method creates a dictionary with proper attributess"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_str(self):
        ...
        self.asser`tEqual(string, str(amenity))
